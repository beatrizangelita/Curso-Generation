...
public class Menu1ProjetoJava {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n                  Obrigada pelas informações " + Cores.TEXT_YELLOW_BRIGHT
				+ firstUser.setNome(nome) + Cores.TEXT_RESET + "! Agora vamos te apresentar o nosso menu: ");
		System.out.println(Cores.TEXT_RESET);
		do {
			...
			case 1:
				...
				do {
					...
					case 2:
						System.out.println("\nDigite o valor da sua Renda Variavel:");
						varRenda = leia.nextDouble();
						rendaVar.add(varRenda);
						System.out.println("\nRenda Variavel adicionada com sucesso!");
			...
			case 2:
				...
				do {
					...
					case 2:
						System.out.println("\nDigite o valor da sua Despesas Casuais:");
						...
						do {
							...
							case 2:
								...
								if (vazio == true) {
									...
									double removeFixa = leia.nextDouble();
									if (despesaFixa.contains(removeFixa)) {
										despesaFixa.remove(removeFixa);
									}
								}
			...
			case 3:
				...
				do {
					...
					case 1:
						...
						System.out.println("\n Valor inserido na poupança com sucesso.");
					...
					case 2:
						...
						if (vazio == true) {
							...
							System.out.println("\n Todos os valores inseridos na poupança: $" + listaPoup);
						}
					...
					case 3:
						...
						if (vazio == true) {
							...
							System.out.println(listaPoup);
							System.out.println("\n Digite o valor que deseja remover: ");
							double removePoup = leia.nextDouble();
							if (listaPoup.contains(removePoup)) {
								listaPoup.remove(removePoup);
								System.out.print("Valor removido com sucesso!");
							} else {
								System.out.print("Valor digitado não encontrado!");
							}
						}
			...
			case 5:
				...
				do {
					...
					case 1:
						...
						System.out.println("|  Despesas Variavel: R$" + totalDespVar + "			   |");
						System.out.println("|  Poupanca: R$" + somaPoup + "  					   	   |");
			...
			case 6:
				System.out.println(Cores.ANSI_YELLOW_BACKGROUND_BRIGHT + Cores.TEXT_BLUE_BOLD_BRIGHT);
				System.out.println(" __________________________________________________________");
